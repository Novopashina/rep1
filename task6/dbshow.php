                ...
                foreach ($values as $value) {
                    ...
                    echo    '<td> 
                                <div class="column-item">
                                    <input'; if(empty($_COOKIE['edit']) || ($_COOKIE['edit'] != $value['application_id'])) print(" disabled ");
                                        else print(" "); echo 'type="radio" id="radioMale'.$value['application_id'].'" name="gender'.$value['application_id'].'" value="male" '; if ($value['gender'] == 'male') echo 'checked'; echo '>
                                    <label for="radioMale'.$value['application_id'].'">Мужчина</label>
                                </div>
                                <div class="column-item">
                                    <input'; if(empty($_COOKIE['edit']) || ($_COOKIE['edit'] != $value['application_id'])) print(" disabled ");
                                        else print(" "); echo 'type="radio" id="radioFemale'.$value['application_id'].'" name="gender'.$value['application_id'].'" value="female" '; if ($value['gender'] == 'female') echo 'checked'; echo '>
